#!/usr/bin/env python
# Nosetests for the TopoFlow Erode_D8_Local component.
# This component has no input or output variables, obviating
# many of the tests.

import os
import shutil
from nose.tools import assert_is_not_none, assert_equals
from cmt.components import ErodeD8Local as Component
from . import data_dir, test_dir


cfg_file = os.path.join(data_dir, 'Erode_D8_Local.cfg')
out_dir = './out'
# var_name = 'land_surface__initial_elevation'
