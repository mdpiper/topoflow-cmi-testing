#!/usr/bin/env python
# Nosetests for the TopoFlow D8_Local component.

import os
import shutil
from nose.tools import assert_is_not_none, assert_equals
from cmt.components import D8Local as Component
from . import data_dir, test_dir


cfg_file = os.path.join(data_dir, 'D8_Local.cfg')
out_dir = './out'
