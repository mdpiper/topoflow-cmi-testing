#!/usr/bin/env python
# Nosetests for the TopoFlow ChannelsDynamWave component.
...
var_name = 'channel_water_x-section__volume_flow_rate'
...
def test_get_component_name():
    ...
    assert_equals(x, 'Channels_Dynamic_Wave')
