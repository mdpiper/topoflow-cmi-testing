#!/usr/bin/env python
# Nosetests for the TopoFlow InfilRichards1D component.
...
var_name = 'soil_surface_water__infiltration_volume_flux'
...
def test_get_component_name():
    ...
    assert_equals(x, 'TopoFlow_Infiltration_Richards_1D')
